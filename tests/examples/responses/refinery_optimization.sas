proc optmodel;
   ...
   con blending_fuel_oil_light_oil_fuel_oil : 8 * flow['light_oil', 'fuel_oil'] - 10 * flow['heavy_oil', 'fuel_oil'] - 10 * flow['cracked_oil', 'fuel_oil'] - 10 * flow['residuum', 'fuel_oil'] = 0;
   con blending_fuel_oil_heavy_oil_fuel_oil : 15 * flow['heavy_oil', 'fuel_oil'] - 3 * flow['light_oil', 'fuel_oil'] - 3 * flow['cracked_oil', 'fuel_oil'] - 3 * flow['residuum', 'fuel_oil'] = 0;
   con blending_fuel_oil_cracked_oil_fuel_oil : 14 * flow['cracked_oil', 'fuel_oil'] - 4 * flow['light_oil', 'fuel_oil'] - 4 * flow['heavy_oil', 'fuel_oil'] - 4 * flow['residuum', 'fuel_oil'] = 0;
   con blending_fuel_oil_residuum_fuel_oil : 17 * flow['residuum', 'fuel_oil'] - flow['light_oil', 'fuel_oil'] - flow['heavy_oil', 'fuel_oil'] - flow['cracked_oil', 'fuel_oil'] = 0;
