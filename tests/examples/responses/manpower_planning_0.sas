proc optmodel;
   ...
   min redundancy_obj = numRedundant['unskilled', 1] + numRedundant['unskilled', 2] + numRedundant['unskilled', 3] + numRedundant['semiskilled', 1] + numRedundant['semiskilled', 2] + numRedundant['semiskilled', 3] + numRedundant['skilled', 1] + numRedundant['skilled', 2] + numRedundant['skilled', 3];
   solve;
quit;